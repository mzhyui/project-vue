      ...
      <el-menu :default-openeds="['1',]">
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="1-1">分组1</el-menu-item>
            <el-menu-item index="1-2">分组2</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group title="分组2">
            <el-menu-item index="1-3">分组3</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="2">
          ...
          <el-menu-item-group>
            <template slot="title">分组一</template>
            <el-menu-item index="2-1">分组1</el-menu-item>
            <el-menu-item index="2-2">分组2</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group title="分组2">
            <el-menu-item index="2-3">分组3</el-menu-item>
          </el-menu-item-group>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            <template slot="title">分组一</template>
            <el-menu-item index="3-1">分组1</el-menu-item>
            <el-menu-item index="3-2">分组2</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group title="分组2">
            <el-menu-item index="3-3">分组3</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
      </el-menu>
    </el-aside>
      ...
      <!-- <el-dropdown>
        ...
        <!-- <el-dropdown>
          <el-button type="primary">
            患者管理<i class="el-icon-arrow-down el-icon--right"></i>
          </el-button>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>查看</el-dropdown-item>
